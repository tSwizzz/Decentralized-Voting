...
contract Voting {
    mapping(uint256 => Vote) votes; //id that points to a vote listing
    mapping(address => bool) public members; //checks to see if address/user is a member
    ...
    struct Vote {
        ...
        uint256 options; //amount of different options to vote from
    }
